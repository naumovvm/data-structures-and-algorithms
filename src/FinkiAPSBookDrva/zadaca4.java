...
public class zadaca4 { // Suma na site jazli sho imat levi deca, str 299
...
//        }
    ...
    public static void main(String[] args) {
        ...
        int root = 1;
        tree.makeRoot(root);
        mapa.put(root, tree.root);

        BNode<Integer> parent = mapa.get(root);
        BNode<Integer> child = tree.addChild(parent, 1, 7);
        mapa.put(7, child);

        parent = mapa.get(7);
        child = tree.addChild(parent, 1, 2);
        mapa.put(2, child);

        parent = tree.root;
        child = tree.addChild(parent, 2, 9);
        mapa.put(9, child);

        parent = mapa.get(9);
        child = tree.addChild(parent, 2, 19);
        mapa.put(19, child);

        parent = mapa.get(19);
        child = tree.addChild(parent, 1, 15);
        mapa.put(15, child);

        int count = sumaLeviDeca(mapa.get(root));
    ...
    private static int sumaLeviDeca(BNode<Integer> root) {
        if (root == null) {
            return 0;
        }
        ...
        count += sumaLeviDeca(root.left);
        count += sumaLeviDeca(root.right);
