...
//        }
        ...
        public int inorderR(BNode<Integer> n) {
            int count = 0;
            if (n != null) {
                count += inorderR(n.left);
//                System.out.print(n.info.toString() + " ");
                count += n.info;
                count += inorderR(n.right);
            }
    ...
    public static void main(String[] args) {
        ...
        parent = mapa.get(6);
        child = tree.addChild(parent, 1, 5);
        mapa.put(5, child);

        parent = mapa.get(6);
        child = tree.addChild(parent, 2, 11);
        mapa.put(11, child);
        ...
        System.out.println(tree.inorderR(root));
