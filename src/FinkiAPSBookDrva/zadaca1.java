...
//        }
    ...
    public static void main(String[] args) {
        ...
        BNode<String> parent = mapa.get("apple");
        tree.addChild(parent, 1, "pear");
        BNode<String> child = tree.addChild(parent, 2, "banana");
        mapa.put("banana", child);

        parent = mapa.get("banana");
        tree.addChild(parent, 1, "lemon");
        tree.addChild(parent, 2, "orange");
