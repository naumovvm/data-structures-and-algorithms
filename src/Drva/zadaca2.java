...
public class zadaca2 { // lab2 za drva
    ...
    public static class BTree<E> {
        ...
        public int sumDegreesR(BNode<E> node){
            if(node==null){
                return 0;
            }
            ...
            return count+sumDegreesR(node.left)+sumDegreesR(node.right);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n + q; i++) {
            ...
            if (command.equals("root")) {
                ...
                String askElement = input.next();
                BNode<String> askNode = hash.get(askElement);
                if (askNode != null) {
                    System.out.println(tree.sumDegreesR(askNode));
                }
            }
        }
