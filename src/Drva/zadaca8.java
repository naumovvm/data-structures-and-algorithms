...
public class zadaca8 { // Zadaca 8 od Drva zadacite
    ...
    public static class BinarySearchTree<E extends Comparable<E>> {
        ...
        public int countElementsWithLargerValOf(BNode<Integer> root, Integer value) {
            if (root == null) {
                return 0;
            }

            int left = countElementsWithLargerValOf(root.left, value);
            int right = countElementsWithLargerValOf(root.right, value);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < (n + q); i++) {
            ...
            if (command.equals("insert")) {
                ...
                int value = input.nextInt();
                System.out.println(tree.countElementsWithLargerValOf(tree.getRoot(), value));
            }
        }
