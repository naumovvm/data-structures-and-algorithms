...
public class zadaca7 { // zadaca 7 od Drva zadacite
    ...
    public static class BinarySearchTree<E extends Comparable<E>> {
        ...
        public int countElementsSmallerThan(BNode<Integer> node, Integer value) {
            if (node == null) {
                return 0;
            }

            int left = countElementsSmallerThan(node.left, value);
            int right = countElementsSmallerThan(node.right, value);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n + q; i++) {
            ...
            if (command.equals("insert")) {
                ...
                System.out.println(tree.countElementsSmallerThan(tree.getRoot(), value));
            }
        }
