...
public class zadaca2 {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        ...
        int sum = 0;
        long result = 1;
        while (mainNode != null) { // pocnuvame od prvata lista da gi izminuvame
            DLL<Integer> subList = mainNode.element;
            DLLNode<Integer> node_of_sublist = subList.getFirst();
            while (node_of_sublist != null) {
                sum += node_of_sublist.element;
                node_of_sublist = node_of_sublist.succ;
            }
