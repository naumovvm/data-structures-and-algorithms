package ZadaciZaVezbanjeVtorKolokvium;

import java.util.Scanner;
import java.util.*;
import java.util.Map.Entry;

public class zadaca1 { // Dedo mraz
...
//            System.out.print(vertex + " ");
        ...
        public int count(T pocetnoEzerce) {
            Set<T> visited = new HashSet<>();
            DFSUtil(pocetnoEzerce, visited);
    ...
    public static void main(String[] args) {
        // u prv red daden e br N - broj na ezera
        // u vtor red daden e br U - broj na reki megju ezerata
        // parovi od R i Q broevi, odnosno reka ima od R do Q
        // na kraj e daden broj L, kade Dedo Mraz ke gi pushti ribite da plovat
        Scanner input = new Scanner(System.in);
        int brEzera = input.nextInt();
        int brReki = input.nextInt();
        AdjacencyListGraph<Integer> graph = new AdjacencyListGraph<>();

        for (int i = 0; i < brReki; i++) {
            int R = input.nextInt();
            int Q = input.nextInt();
            if(R!=Q){
                graph.addEdge(R, Q);
        ...
        int pocetnoEzero = input.nextInt();

        int count = graph.count(pocetnoEzero);
